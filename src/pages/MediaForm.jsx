...
const MediaForm = () => {
    ...
    return <>
        <div className='container p-10 bg-gray-200 h-screen scroll-smooth'>
            <div className=' relative bg-slate-50 h-[75rem] md:h-[45rem] border-2 rounded-lg '>
                <h3 className={`${isSubmitted ? "blur-md" : 'm-2 font-semibold text-gray-700'}`}>Create Text & Media</h3>
                <form action="">
                    <div className={`${isSubmitted ? "blur-md" : 'grid grid-cols-12  p-4 gap-3'}`}>
                        ...
                        <div className='col-span-12 w-full '>
                            <div className=' block md:flex  justify-between w-full items-center gap-3'>
                                <div className=' my-2 flex flex-col gap-3 w-full md:w-[33%]  '>
                                    <label for="name" className=" form-label">Landscape Marketing Image(1.9:1)</label>
                                    <input type="text" className=" border-2 p-2  " id="name" placeholder="Add the URL of the image you want to use for the ad" />
                                </div>
                                <div className='my-2 flex flex-col w-full md:w-[33%] gap-3'>
                                    <label for="name" className="form-label">Portrait Marketing Image(4:5)</label>
                                    <input type="text" className="border-2 p-2" id="name" placeholder="Add the URL of the image you want to use for the ad" />
                                </div>
                                <div className='my-2 flex flex-col w-full md:w-[33%] gap-3'>
                                    <label for="name" class="form-label">Square Marketing Image(1:1)</label>
                                    <input type="text" class="border-2 p-2" id="name" placeholder="Add the URL of the image you want to use for the ad" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='col-span-12'>
                            <div className='my-2 flex flex-col w-full  gap-3'>
                                ...
                                <input type="text" class="border-2 p-2" id="name" placeholder="Add the URL of the video you want to use for the ad" />
                            </div>
                        </div>
                        {/* Bussiness */}
                        <div className='col-span-12'>
